...
export default function Savings() {
  ...
  return <div className="space-y-5">
    <section className="relative overflow-hidden rounded-[2rem] border border-[#a78bfa]/40 bg-gradient-to-br from-[#2a1741] via-[#171225] to-[#0c0a12] p-5 shadow-xl shadow-[#8b5cf6]/15 sm:p-7">
      <div className="pointer-events-none absolute -right-7 -top-8 text-8xl opacity-15">🎯</div>
      <div className="relative"><p className="text-xs font-bold uppercase tracking-[.22em] text-[#d8b4fe]">Financial Goal</p><h1 className="mt-1 text-2xl font-black text-[#f5f3ff] sm:text-3xl">Target Budget</h1><p className="mt-2 max-w-lg text-sm leading-relaxed text-[#ddd6fe]/80">Sisihkan dana untuk target tertentu. Setoran mengurangi sisa saldo, bukan total pemasukan.</p><div className="mt-5 flex items-end justify-between rounded-2xl border border-[#c4b5fd]/20 bg-[#0f0c18]/55 p-4 backdrop-blur"><div><p className="text-xs font-semibold text-[#ddd6fe]/65">Total dana disisihkan</p><p className="mt-1 text-2xl font-black text-[#f5f3ff]">{fmt(total)}</p></div><span className="rounded-full bg-[#8b5cf6]/25 px-3 py-1.5 text-xs font-bold text-[#e9d5ff]">{goals.length} target</span></div></div>
    </section>
