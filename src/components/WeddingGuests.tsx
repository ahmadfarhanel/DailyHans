...
export default function WeddingGuests() {
  ...
  return <section className="space-y-5">
    <div className="relative overflow-hidden rounded-3xl border border-forest/15 bg-gradient-to-br from-forest/20 via-gold/10 to-forest-light/15 p-5 shadow-xl shadow-forest/10 sm:p-7">
      ...
      <p className="text-xs font-bold uppercase tracking-[.2em] text-forest/75">Wedding Planner</p>
      <h1 className="mt-1 text-2xl font-bold text-forest sm:text-3xl">Daftar Tamu</h1>
      <p className="mt-2 max-w-lg text-sm text-forest/75">Kelola undangan, keluarga, asal daerah, jumlah pax, RSVP, link undangan, dan import tamu cepat.</p>
    ...
    <div className="rounded-2xl border border-forest/10 bg-white/90 p-4 shadow-lg shadow-forest/5 sm:p-5">
      ...
      <div className="mt-3 grid gap-3">
        <label className="block">
          <span className="mb-1.5 block text-[11px] font-semibold uppercase tracking-wider text-forest/60">File Excel / CSV</span>
        ...
        <label className="block">
          <span className="mb-1.5 block text-[11px] font-semibold uppercase tracking-wider text-forest/60">Bulk text</span>
