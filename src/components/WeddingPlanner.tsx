  ...
  return <div className="space-y-6">
    ...
    <Card title="Kebutuhan Lainnya" icon="🛍️">
      <div className="rounded-2xl border border-forest/10 bg-[#151019] p-4 sm:p-5">
        ...
        <div className="mt-4 flex items-center justify-between rounded-xl border border-forest/15 bg-[#211a25] px-3 py-3"><span className="text-xs font-semibold text-forest/75">Total kebutuhan lain</span><span className="text-base font-black text-forest">-{fmt(needTotal)}</span></div>
